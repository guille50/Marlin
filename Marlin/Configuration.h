...
#define STRING_CONFIG_H_AUTHOR "(C. Arguello, v0.01)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "buttercup"
...
//https://www.prusaprinters.org/calculator/#steppers
...
//(((200)/(1/16))*3)/(7.3*3.1416) 
//200=steps per revolution
//1/16=stepping mode
//3= Extruder Gear Ratio 
//7.3 =Pinch Wheel Diameter
//3.1416 = Pi


#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 418.59 }
